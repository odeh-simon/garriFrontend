...
import closeIcon from '../../../assets/cancel-icon2.svg';
  ...
  return (
    <div className="pt-8 px-8 lg:px-12 lg:pt-16 text-[#FCFCFC] w-full" style={backgroundImage}>
      ...
      <div className="flex flex-col gap-6">
        <h2 className="text-sm md:text-lg lg:text-2xl text-center text-[#C03744] lg:font-bold font-roboto mt-8">
        We&apos;re sorry to hear you&apos;re not satisfied with your order. Let us help make it right. 💬
        </h2>
        <div className="flex flex-col">
          ...
          <label className="flex items-center gap-1 bg-[#E8EBED] p-2 cursor-pointer">
              <p className="text-xs md:text-lg text-[#2D3339]">Attach photo for evidence</p>
              ...
              <div className="w-fit ">
                  <button className="w-full mt-4 text-center font-roboto text-sm md:text-base lg:text-lg text-[#FCFCFC] font-bold p-3 rounded-full bg-transparent hover:text-[#273094] transition">
                    Send Comment
                  </button>
              </div>
          ...
          {image && (
            <div className="relative mt-4">
              <img src={image} alt="Preview" className="w-64 h-64" />
              <button
                className="absolute top-0 right-12 p-1 bg-white rounded-full"
