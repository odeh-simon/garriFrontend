  ...
  return (
    <div className="pt-8 px-8 lg:px-12 lg:pt-16" style={backgroundImage}>
      ...
      <div className="text-[#FCFCFC] mt-8 lg:mt-8 flex flex-col gap-4 lg:gap-9">
        <h2 className="text-lg md:text-[36px] lg:text-[64px] font-bold">Seller&apos;s Bio</h2>
        <div className="flex flex-col items-start lg:flex-row gap-3 lg:gap-10">
          {/* user avatar */}
          <div className="bg-[#FCFCFC] w-[59.665px] h-[59.665px] md:w-[119.333px] md:h-[119.333px] lg:w-[179px] lg:h-[179px] flex-shrink-0 flex items-center justify-center">
            <img src={avatar} alt="user avatar" className="w-[42.332px] h-[42.332px] md:w-[84.667px] md:h-[84.667px] lg:w-[84.667px] lg:h-[84.667px]"/>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-5 text-[#FCFCFC] lg:font-bold font-roboto text-xs md:text-base">
              ...
              <div className="flex items-center">
                {[...Array(3)].map((_, index) => (
                  <svg key={index} className="w-4 h-4 text-white stroke-current fill-current" viewBox="0 0 24 24">
                    <path d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.787 1.4 8.168L12 18.896l-7.334 3.869 1.4-8.168L.132 9.21l8.2-1.192z"/>
                  </svg>
                ))}
                {[...Array(2)].map((_, index) => (
                  <svg key={index} className="w-4 h-4 text-white fill-transparent stroke-current" viewBox="0 0 24 24">
                    <path d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.787 1.4 8.168L12 18.896l-7.334 3.869 1.4-8.168L.132 9.21l8.2-1.192z"/>
                  </svg>
                ))}
              </div>
            ...
            <div className="flex items-center gap-5 text-[#FCFCFC] font-roboto text-xs md:text-base">
              <h3 className="w-fit text-nowrap lg:font-bold">Message Seller:</h3>
        ...
        <div className="flex flex-col gap-4 mt-4">
            <div className="flex items-center justify-center">
                <h2 className="flex py-[10px] text-lg md:text-3xl font-roboto font-extrabold items-center justify-center bg-[#62679C] rounded-lg w-[202.335px] md:w-[404.667px] lg:w-[607px]">
                    Escrow Rules
                </h2>
            </div>
            <ol className="list-decimal list-outside font-roboto text-sm md:text-lg lg:text-xl flex flex-col gap-2">
                <li>Send Hello, if you don&apos;t get reply from seller within 1-24hrs cancel transaction.</li>
                <li>Don&apos;t pay until seller tells you to proceed to pay</li>
                <li>Payback guarantee/refund is within 15 days.</li>
            </ol>
        </div>
        {/* buttons */}
        <div className="flex flex-col lg:flex-row gap-4 justify-center items-center w-[90%] mx-auto lg:w-full mt-10">
            <Button 
            label="Cancel Order"
            bgColor="#FCFCFC"
            hoverBgColor="#8C1823"
        ...
        {/* footer */}
        <div className="text-center lg:font-bold text-sm lg:text-xl font-roboto flex items-center justify-center gap-1 mb-6" >
            <p className="text-[#F5F58C]">Haven&apos;t connected your wallet? {' '}</p>
            <button>
             Connect Wallet
            </button>
        </div>
